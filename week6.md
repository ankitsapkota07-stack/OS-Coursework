...
```
(see week-6-save-commands.png)

Output files created:

bash
ls -la *_test.txt *_baseline.txt
(see week-6-baseline.png)
...
(see week-6-table-for-journal.png and week-6-ab-otput.png)
...
(see week-6-memory-stress-test.png)
...
(see week-6-dd-progress.png)

I/O monitoring:

bash
iostat -dk 2 10 > disk_stress_test.txt
(see week-6-dd-command.png)
...
(see week-6-iperf3-installation.png)
...
(see week-6-swappiness-change-verification.png)
...
sudo sysctl -p
(see week-6-before-and-after-tcp-setting.png)
